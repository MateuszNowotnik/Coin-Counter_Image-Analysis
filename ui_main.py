...
################################################################################
## Form generated from reading UI file 'GUI_BASERGXuUP.ui'
##
...
"")
        ...
        self.frame_top_right.setMaximumSize(QSize(16777215, 100))
        ...
        self.frame_top_btns.setStyleSheet(u"background-color: rgb(29, 26, 39);")
...
"background-image: url(:/icons/icons/dollar.png);\n"
...
"}")
        ...
        sizePolicy.setHeightForWidth(self.frame_top_info.sizePolicy().hasHeightForWidth())
        self.frame_top_info.setSizePolicy(sizePolicy)
        self.frame_top_info.setMinimumSize(QSize(0, 0))
        self.frame_top_info.setMaximumSize(QSize(16777215, 58))
        self.frame_top_info.setStyleSheet(u"/* background-color: rgb(39, 44, 54);*/\n"
"background-color: rgb(42, 37, 56);")
        ...
        self.btn_upload = QPushButton(self.frame_top_info)
        self.btn_upload.setObjectName(u"btn_upload")
        sizePolicy3 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.btn_upload.sizePolicy().hasHeightForWidth())
        self.btn_upload.setSizePolicy(sizePolicy3)
        font2 = QFont()
        font2.setFamily(u"Segoe UI")
        font2.setPointSize(11)
        font2.setBold(True)
        font2.setWeight(75)
        self.btn_upload.setFont(font2)
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/add_file.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_upload.setIcon(icon3)
        self.btn_upload.setIconSize(QSize(20, 20))

        self.horizontalLayout_8.addWidget(self.btn_upload)

        self.btn_run = QPushButton(self.frame_top_info)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/run.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_run.setIcon(icon4)
        self.btn_run.setIconSize(QSize(20, 20))

        self.horizontalLayout_8.addWidget(self.btn_run)

        self.label_sum = QLabel(self.frame_top_info)
        self.label_sum.setObjectName(u"label_sum")
        self.label_sum.setEnabled(True)
        sizePolicy3.setHeightForWidth(self.label_sum.sizePolicy().hasHeightForWidth())
        self.label_sum.setSizePolicy(sizePolicy3)
        self.label_sum.setMinimumSize(QSize(0, 0))
        self.label_sum.setMaximumSize(QSize(250, 58))
        palette1 = QPalette()
        palette1.setBrush(QPalette.Active, QPalette.WindowText, brush6)
        brush15 = QBrush(QColor(42, 37, 56, 255))
...
#endif
        self.label_sum.setPalette(palette1)
        font3 = QFont()
        font3.setFamily(u"Segoe UI")
        font3.setPointSize(18)
        font3.setBold(True)
        font3.setWeight(75)
        self.label_sum.setFont(font3)
        self.label_sum.setFocusPolicy(Qt.StrongFocus)
        self.label_sum.setStyleSheet(u"")
        self.label_sum.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_8.addWidget(self.label_sum)
        ...
        self.frame_left_list = QFrame(self.frame_center)
        self.frame_left_list.setObjectName(u"frame_left_list")
        sizePolicy1.setHeightForWidth(self.frame_left_list.sizePolicy().hasHeightForWidth())
        self.frame_left_list.setSizePolicy(sizePolicy1)
        self.frame_left_list.setMinimumSize(QSize(350, 0))
        self.frame_left_list.setMaximumSize(QSize(500, 16777215))
        self.frame_left_list.setLayoutDirection(Qt.LeftToRight)
        self.frame_left_list.setStyleSheet(u"background-color: rgb(27, 29, 35);")
        self.frame_left_list.setFrameShape(QFrame.NoFrame)
        self.frame_left_list.setFrameShadow(QFrame.Raised)
        self.verticalLayout_5 = QVBoxLayout(self.frame_left_list)
        self.verticalLayout_5.setSpacing(1)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.tableWidget = QTableWidget(self.frame_left_list)
        ...
        brush19 = QBrush(QColor(39, 35, 52, 255))
...
"")
        ...
        self.horizontalLayout_2.addWidget(self.frame_left_list)

        self.frame_right_image = QFrame(self.frame_center)
        self.frame_right_image.setObjectName(u"frame_right_image")
        self.frame_right_image.setMinimumSize(QSize(800, 0))
        self.frame_right_image.setStyleSheet(u"background-color: rgb(50, 44, 66);")
        self.frame_right_image.setFrameShape(QFrame.NoFrame)
        self.frame_right_image.setFrameShadow(QFrame.Raised)
        self.verticalLayout_4 = QVBoxLayout(self.frame_right_image)
        self.verticalLayout_4.setSpacing(0)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.frame_content = QFrame(self.frame_right_image)
        ...
        self.label_image = QLabel(self.frame_content)
        self.label_image.setObjectName(u"label_image")

        self.verticalLayout_9.addWidget(self.label_image)


        self.verticalLayout_4.addWidget(self.frame_content)

        self.frame_grip = QFrame(self.frame_right_image)
        ...
        self.label_footer = QLabel(self.frame_label_bottom)
        self.label_footer.setObjectName(u"label_footer")

        self.horizontalLayout_7.addWidget(self.label_footer)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.frame_right_image)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_upload.setText(QCoreApplication.translate("MainWindow", u" Upload Image", None))
